...
namespace VisSim
{
    /* What is buggy? vertBlurVertical!
     * vertBlurHorizontal works fine.
     * 
     * When you build the app and put it on the headset, you get some kind of strange horizontal cutline.
     * half4 tap = tex2D(_MainTex, UnityStereoScreenSpaceUVAdjust(coords, _MainTex_ST));
     * -> half4 tap = tex2D(_MainTex, coords); or _Parameter.y; did not help, too.
     * 
     * And why it appls the vertical blur here 2x is also a mistery to me, but not the issue ....
     * 
     * Chears, Alexander.
     */
