    ...
    abstract public class LinkableBaseEffect : BaseEffect
    {
		...
		*/
        ...
        public void OnEnable()
        {
            ...
            Component[] leftEyeEffectInstances = GetComponentsInChildren(this.GetType());
            rightEyeEffectInstance = leftEyeEffectInstances[0] as LinkableBaseEffect;
            leftEyeEffectInstance = rightEyeEffectInstance;
            /* TODO: Alexander H. deactivated linking and checks to support central camera!
             * Need to create a better solution!
             * 
             * 
